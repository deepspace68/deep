            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">List of events</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
...
<table  class="table table-striped table-bordered table-hover" id="table_js" data-buttons-class='default  btn-outline' data-search="true" data-show-columns="true" data-show-toggle="true" data-click-to-select="true"  data-pagination="true"  data-height="500">
    ...
    foreach($listeProduits as $row){
        ...
        <tr>
            ...
            <td><form method="POST" action="calculerPeriode.php">
                    <input type="submit" name="periode" value="periode">
    ...
    ?>
        ...
        <footer class="footer container-fluid pl-30 pr-30">
            <div class="row">
                <div class="col-sm-12">
                    <p>2018 &copy;Animalia. Pampered by Hencework</p>
                </div>
            </div>
        </footer>
        <!-- /Footer -->
